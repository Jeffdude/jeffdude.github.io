...
export const projects: Project[] = [
  ...
  {
    title: "Trellisware Mobile App",
    projectId: "trellisware-mobile-app",
    shortDescription: "Critical customer-facing React Native Android App",
    techStack: [Tech.Javascript, Tech.Typescript, Tech['React Native']],
    page: () => <UnderConstructionPage/>,
    underConstruction: true,
  },
  {
    title: "Trellisware Website App",
    projectId: "trellisware-website",
    shortDescription: "Large legacy javascript codebase, which I shepherded into the modern world of Typescript",
  ...
  },
  {
    ...
    page: () => <UnderConstructionPage/>,
    links: [
      {tooltip: "Github", link: "https://github.com/Jeffdude/jeffdude.github.io"},
    ],
    underConstruction: true,
  },
  {
